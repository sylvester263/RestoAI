...
| 11 | `impl-11-landing-page-builder.md` | Existing public ordering app (`/order/:tenantSlug`) — CTA target | Medium |
...
11. Restaurant landing page builder (templates + custom domain) — market-research-driven addition, directly counters the Foodpanda-commission pain point

...
export default function WhatsAppDemo() {
  ...
  return (
    <div>
      <div className="mb-6">
        <h1 className="text-2xl font-bold text-[var(--text-primary)]">WhatsApp Order Demo</h1>
        <p className="text-sm text-[var(--text-secondary)]">Simulate WhatsApp ordering without needing the real API</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2">
          <div className="card flex h-[600px] flex-col p-0 overflow-hidden">
            {/* Chat header */}
            <div className="flex items-center gap-3 border-b border-[var(--border)] bg-green-600 px-4 py-3">
            ...
            <div className="flex-1 overflow-y-auto bg-[#ECE5DD] p-4 space-y-3">
              ...
              {loading && (
                <div className="flex justify-start">
                  <div className="rounded-lg bg-[var(--surface-2)] px-4 py-2 shadow-sm">
            ...
            {/* Input */}
            <div className="flex gap-2 border-t border-[var(--border)] bg-[var(--surface-2)] p-3">
              <input
        ...
        <div className="space-y-4">
          ...
          <div className="card">
            <div className="flex items-center gap-2 mb-3">
              ...
              <h3 className="text-sm font-semibold text-[var(--text-primary)]">Simulated Phone</h3>
            </div>
          ...
          {/* Quick messages */}
          <div className="card">
            <h3 className="mb-3 text-sm font-semibold text-[var(--text-primary)]">Try these messages</h3>
            <div className="space-y-2">
              {sampleMessages.map((msg, i) => (
                <button
                  key={i}
                  onClick={() => { setMessage(msg); }}
                  className="w-full rounded-lg border border-[var(--border)] px-3 py-2 text-left text-xs text-[var(--text-secondary)] hover:bg-brand-50 hover:border-brand-300 transition-colors"
                >
                  {msg}
                </button>
              ))}
          ...
          {/* How it works */}
          <div className="card bg-[var(--surface-3)]">
            <div className="flex items-center gap-2 mb-3">

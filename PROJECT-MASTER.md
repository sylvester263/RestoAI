...
**Last updated:** 2026-09-25 (User-Manual QA fix pass, Section 2.2) · **Purpose:** Single source of truth for this project's current state, architecture, and roadmap. Load this file instead of re-explaining project history in future agent sessions.
...
6. Decide pricing/commission stance — the tiered model in `impl-22` v2 is a recommendation, not confirmed (Section 5.3); a tenant-facing subscription/plan page (confirmed absent) depends on it
